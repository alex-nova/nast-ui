export default {
  props: {
    ...
    // [ { value: (item) => {}, sort: (item) => {}, filter: (item, value) => {}, }, sortFunction, ]
    ...
    search: { type: [ String, Array, ], default: '', },
    filter: { type: Object, default: () => ({}), }, // { n1: [ 'in', 'q', 'w', ], n2: 'q', n3: [ 'between', 1, 20, ], n4: [ 'search', 'q', ], }
